...
public class Test {
   ...
   /* public static void main(String[] args) {
        *//*for(int i=0;i<1000000000;i++){
            System.out.printf("gggggggggg");
        }*//*

       *//* try {
            ClassLoader classLoader=Thread.currentThread().getContextClassLoader();
            Class bean=classLoader.loadClass(ProductInfo.class.getName());
            ProductInfo b=(ProductInfo)bean.newInstance();
            b.setId(1);
    ...
    public static void main(String[] args) {
        ...
        System.out.println(Test.calcCrc16("1".getBytes())&16383);

        System.out.println( Hashing.crc32().hashBytes("1".getBytes()).asInt()&16383);
    }
